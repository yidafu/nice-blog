...
open class BUserToken(
   ...
   */
  val ID: TableField<BUserTokenRecord, Long?> = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false).identity(true), this, "")

  /**
   * The column <code>B_USER_TOKEN.CREATED_AT</code>.
   */
  val CREATED_AT: TableField<BUserTokenRecord, LocalDateTime?> =
    createField(
      DSL.name("CREATED_AT"),
   ...
   */
  val UPDATED_AT: TableField<BUserTokenRecord, LocalDateTime?> =
    createField(
      DSL.name("UPDATED_AT"),
      SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)),
      this,
   ...
   */
  val CREATED_BY: TableField<BUserTokenRecord, String?> =
    createField(DSL.name("CREATED_BY"), SQLDataType.VARCHAR(255).nullable(false), this, "")
   ...
   */
  val EXPIRES_AT: TableField<BUserTokenRecord, LocalDateTime?> =
  ...
  override fun getIdentity(): Identity<BUserTokenRecord, Long?> = super.getIdentity() as Identity<BUserTokenRecord, Long?>
  ...
  ): BUserToken = where(DSL.condition(condition))
  ...
  @PlainSQL override fun where(
    @Stringly.SQL condition: String,
    vararg binds: Any?,
  ): BUserToken = where(DSL.condition(condition, *binds))
  ...
  ): BUserToken = where(DSL.condition(condition, *parts))
