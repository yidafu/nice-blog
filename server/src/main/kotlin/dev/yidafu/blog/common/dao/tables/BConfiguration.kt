...
open class BConfiguration(
   ...
   */
  val ID: TableField<BConfigurationRecord, Long?> =
    createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false).identity(true), this, "")

  /**
   * The column <code>B_CONFIGURATION.CREATED_AT</code>.
   */
  val CREATED_AT: TableField<BConfigurationRecord, LocalDateTime?> =
    createField(
      DSL.name("CREATED_AT"),
   ...
   */
  val UPDATED_AT: TableField<BConfigurationRecord, LocalDateTime?> =
    createField(
      DSL.name("UPDATED_AT"),
      SQLDataType.LOCALDATETIME(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)),
      this,
  ...
  ): BConfiguration = where(DSL.condition(condition))
  ...
  @PlainSQL override fun where(
    @Stringly.SQL condition: String,
    vararg binds: Any?,
  ): BConfiguration = where(DSL.condition(condition, *binds))
  ...
  ): BConfiguration = where(DSL.condition(condition, *parts))
