...
fun FlowContent.footerBlock() {
  footer {
    style = kw.inline { padding[5]; background.color["#f7f8f9"]; flex.row.justify_center.items_center; text.gray[I300] }
 ...
 */
fun FlowContent.alert(msg: String, type: EAlertType = EAlertType.INFO) {
